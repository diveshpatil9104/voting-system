...
def voterLogin():
    ...
    label0 = Label(loginFrame, text="Voter Id ", font=(ARIAL, 12, "normal"), bg="white", fg="black")
    label0.place(x=100, y=150)
    input0 = Entry(loginFrame, font=(ARIAL, 12), textvariable=voterId, border=0, bg="#f0f0f0", fg="black")
    ...
    Login_btn = Button(loginFrame, text="Login", font=(ARIAL, 13, "bold"), command=Login, border=0, bg=HIGHLIGHT_BG, fg="black")
    Login_btn.place(x=250, y=250, width=100, height=50)
...
def dashboard(voterId):
    ...
    nameLabel = Label(DashboardFrame, text="Hi, "+name.get(), font=(ARIAL, 15, "normal"), bg="white", fg="black")
    nameLabel.place(x=75, y=150)

    pollLabel = Label(DashboardFrame, text="Select your poll ", font=(ARIAL, 15, "normal"), bg="white", fg="black")
    ...
    districtLabel = Label(DashboardFrame, text="Select your Distric", font=(ARIAL, 15, "normal"), bg="white", fg="black")
    ...
    Vote_btn = Button(DashboardFrame, text="Vote", font=(ARIAL, 13, "normal"), command=Vote, border=0, bg=HIGHLIGHT_BG, fg="black")
...
def voterRegistration():
    ...
    label0 = Label(RegistrationFrame, text="Voter Id ", font=(ARIAL, 12, "normal"), bg="white", fg="black")
    label0.place(x=30, y=125)
    input0 = Entry(RegistrationFrame, font=(ARIAL, 12), textvariable=voterId, border=0, bg="#f0f0f0", fg="black")
    input0.place(x=250, y=125, width="200", height="25")

    label1 = Label(RegistrationFrame, text="Full Name ", font=(ARIAL, 12, "normal"), bg="white", fg="black")
    label1.place(x=30, y=175)
    input1 = Entry(RegistrationFrame, font=(ARIAL, 12), textvariable=name, border=0, bg="#f0f0f0", fg="black")
    input1.place(x=250, y=175, width="200", height="25")

    label2 = Label(RegistrationFrame, text="Aadhar Card Number", font=(ARIAL, 12, "normal"), bg="white", fg="black")
    label2.place(x=30, y=225)
    input2 = Entry(RegistrationFrame, font=(ARIAL, 12), textvariable=aadhar, border=0, bg="#f0f0f0", fg="black")
    input2.place(x=250, y=225, width="200", height="25")

    label3 = Label(RegistrationFrame, text="Mobile Number", font=(ARIAL, 12, "normal"), bg="white", fg="black")
    label3.place(x=30, y=275)
    input3 = Entry(RegistrationFrame, font=(ARIAL, 12), textvariable=phone, border=0, bg="#f0f0f0", fg="black")
    ...
    Register_btn = Button(RegistrationFrame, text="Register", font=(ARIAL, 13, "bold"), command=Register, border=0, bg=HIGHLIGHT_BG, fg="black")
...
def AdminRegistration():
    ...
    IdLabel = Label(AdminFrame, text="Register Id ", font=(ARIAL, 12, "normal"), bg="white" , fg="black")
    IdLabel.place(x=30, y=125)
    IdInput = Entry(AdminFrame, font=(ARIAL, 12), textvariable=regId, border=0, bg="#f0f0f0" , fg="black")
    IdInput.place(x=250, y=125, width="200", height="25")

    nameLabel = Label(AdminFrame, text="Full Name", font=(ARIAL, 12, "normal"), bg="white" , fg="black")
    nameLabel.place(x=30, y=175)
    nameInput = Entry(AdminFrame, font=(ARIAL, 12), textvariable=name, border=0, bg="#f0f0f0", fg="black")
    nameInput.place(x=250, y=175, width="200", height="25")

    aadharLabel = Label(AdminFrame, text="Aadhar Card Number", font=(ARIAL, 12, "normal"), bg="white" , fg="black")
    aadharLabel.place(x=30, y=225)
    aadharInput = Entry(AdminFrame, font=(ARIAL, 12), textvariable=aadhar, border=0, bg="#f0f0f0", fg="black")
    aadharInput.place(x=250, y=225, width="200", height="25")

    phoneLabel = Label(AdminFrame, text="Mobile Number", font=(ARIAL, 12, "normal"), bg="white" , fg="black")
    phoneLabel.place(x=30, y=275)
    phoneInput = Entry(AdminFrame, font=(ARIAL, 12), textvariable=phone, border=0, bg="#f0f0f0" , fg="black")
    phoneInput.place(x=250, y=275, width="200", height="25")

    genderlabel = Label(AdminFrame, text="Gender", font=(ARIAL, 12, "normal"), bg="white" , fg="black")
    ...
    Register_btn = Button(AdminFrame, text="Register", font=(ARIAL, 13, "bold"), command=Register, border=0, bg=HIGHLIGHT_BG, fg="black")
...
def VoterHome():
    ...
    login_btn = Button(voterFrame, text="Login", font=(ARIAL, 13, "bold"),command=voterLogin, relief=FLAT, border=0, bg=HIGHLIGHT_BG, fg="black")
    ...
    reg_btn = Button(btn_border, text="Register", font=(ARIAL, 13, "bold"), command=voterRegistration, relief=FLAT, border=0, bg="white", fg="black")
...
def AdminHome():
    ...
    adminFrame.configure(background="white")
    login_btn = Button(adminFrame, text="Login", font=(ARIAL, 13, "bold"),command=AdminLogin, relief=FLAT, border=0, bg=HIGHLIGHT_BG, fg="black")
    login_btn.place(x=150, y=150, width=150, height=50)
    btn_border = LabelFrame(adminFrame, bd = 0, bg = HIGHLIGHT_BG)
    btn_border.place(x=150, y=250, width=150, height=50)
    reg_btn = Button(btn_border, text="Register", font=(ARIAL, 13, "bold"), command=AdminRegistration, relief=FLAT, border=0, bg="white", fg="black")
    reg_btn.place(x=1, y=1, width=148, height=48)
    back_btn = Button(adminFrame, text="< Back", font=(ARIAL, 10, "normal"), command=Home, border=0, bg="white", fg="grey")
    back_btn.place(x=0, y=0, width=100, height=50)
    label = Label(adminFrame, text="Your Vote,\nYour Voice", font=(LUCIDA_CONSOLE, 30, "bold"), bg=HIGHLIGHT_BG, fg="white")
    label.place(x=500, y=0, width=400, height=500)
...
def AdminLogin():
    ...
    IdLable = Label(LoginFrame, text="Register Id", font=(ARIAL, 12, "normal"), bg="white", fg="black")
    IdLable.place(x=100, y=150)
    IdInput = Entry(LoginFrame, font=(ARIAL,12,"normal"), textvariable=regId, border=0, bg="#f0f0f0" , fg="black")
...
def AdminDashboard(regId):
    ...
    adres_btn = Button(menu_bar, text="new admin Registration" ,font=(ARIAL, 13, "normal"), command=Home, border=0, bg="white", fg="grey", anchor="w", padx=30)
    adres_btn.place(x=0, y=406, width=249, height=50)
    space = Label(menu_bar, bg="white")
    space.place(x=0, y=506, width=249, height=100)
...
def votingResults():
    ...
    # Get the total vote count and total user count
    result = model.getTotalCount()  # This returns an integer like 123
    t_user = model.getTotalUserCount()  # This returns an integer like 456

    # Update the total count label
    totalCount = Label(resultFrame, text="{}  /  {}".format(result, t_user), font=("", 15, "bold"), bg="white" , fg="black")
    totalCount.place(x=400, y=50)

    # Get party vote counts
    result1 = model.getPartyCount("BJP")
    count1 = Label(resultFrame, text=result1, font=("", 15, "bold"), bg="white" , fg= "black")
    count1.place(x=400, y=150)

    result1 = model.getPartyCount("TMC")
    count2 = Label(resultFrame, text=result1, font=("", 15, "bold"), bg="white" ,  fg= "black")
    count2.place(x=400, y=200)

    result1 = model.getPartyCount("SP")
    count3 = Label(resultFrame, text=result1, font=("", 15, "bold"), bg="white",  fg= "black")
    count3.place(x=400, y=250)

    result1 = model.getPartyCount("AAP")
    count4 = Label(resultFrame, text=result1, font=("", 15, "bold"), bg="white" ,  fg= "black")
...
def showAllRecord():
    ...
    y=75
    for r in result:
        nameValue=Label(DataFrame,text=r[0],font=(ARIAL,12,"normal"),bg="white",fg="black")
        nameValue.place(x=x,y=y)
        x+=200
        phoneValue=Label(DataFrame,text=r[1],font=(ARIAL,12,"normal"),bg="white",fg="black")
        phoneValue.place(x=x,y=y)
        x+=160
        genderValue=Label(DataFrame,text=r[2],font=(ARIAL,12,"normal"),bg="white",fg="black")
        genderValue.place(x=x,y=y)
        x+=125
        addressValue=Label(DataFrame,text=r[3],font=(ARIAL,12,"normal"),bg="white",fg="black")
...
def searchUser():
    ...
    aadharLabel = Label(SearchFrame, text="Aadhar Card Number", font=("", 13, "normal"), bg="white" , fg= "black")
    aadharLabel.place(x=50, y=55, height=30)
    aadharInput = Entry(SearchFrame, textvariable=aadhar,font=("",12,"normal"), bg="#f0f0f0",fg= "black", border=0)
    ...
    def search():
        if aadhar.get() == "" or len(aadhar.get()) != 12 or not aadhar.get().isdigit():
            ...
            if(user == None):
                ...
                DataFrame.configure(background="white")
                name = Label(DataFrame, text="Name :", font=(ARIAL, 13, "bold"), bg="white",fg="black")
                name.place(x=0, y=0, height=30)
                nameValue = Label(DataFrame, text=user[0], font=(ARIAL, 12, "normal"), bg="white",fg="black")
                nameValue.place(x=150, y=0, height=30)
                phone = Label(DataFrame, text="Mobile Number :", font=(ARIAL, 13, "bold"), bg="white",fg="black")
                phone.place(x=0, y=50, height=30)
                phoneValue = Label(DataFrame, text=user[1], font=(ARIAL, 12, "normal"), bg="white",fg="black")
                phoneValue.place(x=150, y=50, height=30)
                gender = Label(DataFrame, text="Gender :", font=(ARIAL, 13, "bold"), bg="white",fg="black")
                gender.place(x=0, y=100, height=30)
                genderValue = Label(DataFrame, text=user[2], font=(ARIAL, 12, "normal"), bg="white",fg="black")
                genderValue.place(x=150, y=100, height=30)
                locality = Label(DataFrame, text="Locality :", font=(ARIAL, 13, "bold"), bg="white",fg="black")
                locality.place(x=0, y=150, height=30)
                localityValue = Label(DataFrame, text=user[3], font=(ARIAL, 12, "normal"), bg="white",fg="black")
                localityValue.place(x=150, y=150, height=30)
                    

    search_btn = Button(SearchFrame, text="SEARCH", font=(ARIAL, 12, "bold"), command=search, border=0, bg=HIGHLIGHT_BG, fg="black")
...
def updateUser():
    ...
    aadharLabel = Label(UpdateFrame, text="Aadhar Card Number", font=("", 13, "normal"), bg="white", fg="black")
    aadharLabel.place(x=50, y=55, height=30)
    aadharInput = Entry(UpdateFrame, textvariable=aadhar,font=("",12,"normal"), bg="#f0f0f0", fg="black", border=0)
    aadharInput.place(x=230, y=55, width=170, height=30)
    def search():
        if aadhar.get() == "" or len(aadhar.get()) != 12 or not aadhar.get().isdigit():
            messagebox.showwarning('Voting System Message', '🎱 Field is requird\n🎱 Aadhar number length must be 12 digit')
            ...
            if(user == None):
                ...
                nameLabel = Label(DataFrame, text="Name ", font=(ARIAL, 13, "bold"), bg="white", fg="black")
                nameLabel.place(x=0, y=0, height=30)
                nameValue = Entry(DataFrame, font=(ARIAL, 12, "normal"), textvariable=name, border=0, bg="#f0f0f0" , fg="black")
                nameValue.insert(0, user[2])
                nameValue.place(x=150, y=0, width=200, height=30)

                phoneLabel = Label(DataFrame, text="Mobile Number ", font=(ARIAL, 13, "bold"), bg="white", fg="black")
                phoneLabel.place(x=0, y=50, height=30)
                phoneValue = Entry(DataFrame, font=(ARIAL, 12, "normal"), textvariable=phone, border=0, bg="#f0f0f0", fg="black")
                phoneValue.insert(0, user[4])
                phoneValue.place(x=150, y=50, width=200, height=30)

                genderLabel = Label(DataFrame, text="Gender ", font=(ARIAL, 13, "bold"), bg="white", fg="black")
                ...
                update_btn = Button(DataFrame, text="Update", font=(ARIAL, 12, "normal"), command=update, border=0, bg=HIGHLIGHT_BG, fg="black")
                update_btn.place(x=150, y=175, width=100, height=40)

    search_btn = Button(UpdateFrame, text="SEARCH", font=(ARIAL, 12, "bold"), command=search, border=0, bg=HIGHLIGHT_BG, fg="black")
    search_btn.place(x=450, y=50, width=150, height=40)
...
def deleteUser():
    ...
    aadharLabel = Label(DeleteFrame, text="Aadhar Number", font=(ARIAL, 13, "bold"), bg="white",fg="black")
    aadharLabel.place(x=100, y=150, height=30)
    aadharValue = Entry(DeleteFrame, textvariable=aadhar,font=(ARIAL,12,"normal"), bg="#f0f0f0" ,fg="black", border=0)
    ...
    delete_btn = Button(DeleteFrame, text="Delete", font=(ARIAL, 13, "normal"), command=delete, border=0, bg=HIGHLIGHT_BG, fg="black")
...
def open_browser(e):
    webbrowser.open_new("https://github.com/diveshpatil9104")
